        ...
        <Fragment>
            ...
            <section id="two" className="d-flex flex-column justify-content-center align-items-center">
                ...
                <div className="d-flex justify-content-center align-items-center border border-2" style={{ width: "60vw", height: "7.2vh" }}>
                    <h5 style={{ fontSize: 30, fontWeight: "400" }}>กิจกรรม หุบเขาจักรกล</h5>
                </div><br />
                <div className="d-flex flex-column justify-content-start" style={{ width: "60vw" }}>
                    ...
                    <p style={{ fontSize: 16, marginTop: "-20px" }}>วันศุกร์ที่ 12 พฤศจิกายน 2564 - วันพฤหัสบดีที่ 18 พฤศจิกายน 2564 เวลา 23.59 น.</p>
                    <p className="text-success" style={{ fontSize: 16, fontWeight: "bold" }}>เข้าร่วมกิจกรรมได้ผ่านทางตัวเกม &gt;&gt; หน้าแรก &gt;&gt; Overview &gt;&gt; หุบเขาจักรกล</p>
                    <p className="text-success" style={{ fontSize: 16, fontWeight: "bold" }}>วิธีใช้งาน</p>
                    <p style={{ fontSize: 16, marginTop: "-20px" }}>
                        ...
                        <ul style={{ marginBottom: "0px" }}><li>*รูปกล่องสมบัติ* ในแผนที่คืออะไร??: ผู้เล่นจะรับ [รางวัลใหญ่ที่เลือกไว้] ได้ 1 อย่าง(สุ่ม) โดยทันที!</li></ul>
                    ...
                    <p style={{ fontSize: 16, marginTop: "-20px" }}>
                        ...
                        <ul style={{ marginBottom: "0px" }}><li>เริ่มต้นที่ 99 RP สูงสุด 299 RP</li></ul>
                        ...
                        5. สำหรับปัญหาใดๆ ที่เกี่ยวข้องกับอีเวนท์นี้ โปรดติดต่อ<a href="https://support.garena.in.th/new/games/faqs/9/league-of-legends">ฝ่ายสนับสนุนลูกค้า</a>ของ Garena ประเทศไทย<br />
                    </p>
                    <br />
                    <br />
                    <br />
